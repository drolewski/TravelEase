...
const Navigation = ({isPreviousVisible, onPreviousClick, onNextClick}: NavigationProps) => {
    return (<div className={"flex flex-row m-2" + (isPreviousVisible ? ' justify-between' : ' justify-end')}>
        {isPreviousVisible && <button type="button"
            ...
            <Image className="rotate-180" src="arrow.svg" alt="arrow-back" width={24} height={24}/>
        ...
        <button type="button"
            ...
            <Image src="arrow.svg" alt="arrow-next" width={24} height={24}/>
